...
let _cached_JoinGroupchat_type_value: __AlgebraicTypeType | null = null;
...
export const JoinGroupchat = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_JoinGroupchat_type_value) return _cached_JoinGroupchat_type_value;
    _cached_JoinGroupchat_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_JoinGroupchat_type_value.value.elements.push(
      { name: "groupchat", algebraicType: __AlgebraicTypeValue.String },
    );
    return _cached_JoinGroupchat_type_value;
  },
